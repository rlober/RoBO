...
sys.path.append('/home/numair/Documents/RoBO')
...
epub_title = u'test'
epub_author = u'numair'
epub_publisher = u'numair'
epub_copyright = u'2016, numair'

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'test'
